...
-- \copy (select disease_group_id, min_validation_weighting, min_occurrences_for_presence, min_occurrences_for_possible_presence, max_months_ago_for_higher_occurrence_score, lower_occurrence_score, higher_occurrence_score from disease_extent order by disease_group_id) TO 'disease_extent.txt' (ENCODING utf8, NULL '')

...
\copy disease_group (id, parent_id, name, group_type, public_name, short_name, abbreviation, is_global, validator_disease_group_id, weighting, min_new_occurrences_trigger, min_data_volume, min_distinct_countries, high_frequency_threshold, min_high_frequency_countries, occurs_in_africa) FROM 'disease_group.txt' (ENCODING utf8, NULL '')
...
-- \copy (select id, parent_id, name, group_type, public_name, short_name, abbreviation, is_global, validator_disease_group_id, weighting, min_new_occurrences_trigger, min_data_volume, min_distinct_countries, high_frequency_threshold, min_high_frequency_countries, occurs_in_africa from disease_group order by id) TO 'disease_group.txt' (ENCODING utf8, NULL '')

...
\copy disease_extent (disease_group_id, max_months_ago, min_validation_weighting, min_occurrences_for_presence, min_occurrences_for_possible_presence, max_months_ago_for_higher_occurrence_score, lower_occurrence_score, high_occurrence_score) FROM 'disease_extent.txt' (ENCODING utf8, NULL '')

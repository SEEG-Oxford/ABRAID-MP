...
-- Add Zhi's recommended area calculation projection (http://epsg.io/54009)
...
-- Calculate area using Zhi's recommended 54009 CRS instead of 4326 as it returns NaN for 7 of our countries (postgis bug)

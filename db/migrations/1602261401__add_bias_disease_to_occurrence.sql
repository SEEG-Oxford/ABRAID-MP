...
ALTER TABLE disease_occurrence ADD CONSTRAINT ck_disease_occurrence_bias_disease_group
    CHECK ((status<>'BIAS' AND bias_disease_group_id IS NULL) OR (status='BIAS' AND bias_disease_group_id IS NOT NULL));
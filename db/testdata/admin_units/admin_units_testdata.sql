...
-- \copy (select gaul_code, level, name, pub_name from admin_unit_tropical order by gaul_code) TO 'admin_unit_tropical.txt' (ENCODING utf8, NULL '')
-- \copy (select gaul_code, level, name, pub_name from admin_unit_global order by gaul_code) TO 'admin_unit_global.txt' (ENCODING utf8, NULL '')

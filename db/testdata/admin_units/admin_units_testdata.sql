...
\copy country(gaul_code, name, for_min_data_spread, geom) FROM 'country.txt' (ENCODING utf8, NULL '')
...
-- \copy (select gaul_code, name, for_min_data_spread, geom from country order by gaul_code) TO 'country.txt' (ENCODING utf8, NULL '')

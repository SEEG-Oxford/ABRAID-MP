...
-- \copy (select id, name, geom, precision, geoname_id, resolution_weighting, healthmap_country_id, admin_unit_qc_gaul_code, admin_unit_global_gaul_code, admin_unit_tropical_gaul_code, has_passed_qc from location order by id) TO 'location.txt' (ENCODING utf8, NULL '')

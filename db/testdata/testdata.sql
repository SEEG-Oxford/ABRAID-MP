...
\copy admin_unit_disease_extent_class (global_gaul_code, disease_group_id, disease_extent_class, has_changed) FROM 'admin_unit_disease_extent_class.txt' (ENCODING utf8)

...
\copy disease_occurrence (id, disease_group_id, location_id, alert_id, occurrence_date, system_weighting, validation_weighting) FROM 'disease_occurrence.txt' (ENCODING utf8, NULL '')
...
-- \copy (select id, disease_group_id, location_id, alert_id, occurrence_date, system_weighting, validation_weighting from disease_occurrence order by id) TO 'disease_occurrence.txt' (ENCODING utf8, NULL '')

 ...
 * countries, removing smaller smaller islands etc. Eight large subtropical countries have been divided into admin 1
 * areas. Borders have been simplified to improve rendering performance.
 *
 * Copyright (c) 2014 University of Oxford
 */
@Entity
@Table(name = "admin_unit_simplified_tropical")
@Immutable
public class AdminUnitSimplifiedTropical {
    ...
    public boolean equals(Object o) {
        ...
        AdminUnitSimplifiedTropical that = (AdminUnitSimplifiedTropical) o;

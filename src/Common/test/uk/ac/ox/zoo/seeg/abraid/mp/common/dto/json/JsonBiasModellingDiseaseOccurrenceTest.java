...
public class JsonBiasModellingDiseaseOccurrenceTest {
    ...
    public void serializesCorrectly() throws JsonProcessingException {
        ...
        // Assert
        assertThat(result).isEqualTo("{\"Longitude\":7.0,\"Latitude\":6.0,\"Admin\":4,\"GAUL\":\"3\",\"Disease\":123,\"Date\":\"2008-01-21\"}");
    }
    ...
    public void serializesCorrectlyWithNull() throws JsonProcessingException {
        ...
        // Assert
        assertThat(result).isEqualTo("{\"Longitude\":7.0,\"Latitude\":6.0,\"Admin\":4,\"GAUL\":\"NA\",\"Disease\":123,\"Date\":\"2008-01-21\"}");
    }

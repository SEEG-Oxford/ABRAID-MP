...
public class ModelRunPackageBuilderIntegrationTest {
    ...
    public void buildPackageShouldCreateAZipContainingTheCorrectContent() throws Exception {
        ...
        //Act
        File zip = modelRunPackageBuilder.buildPackage(runName, diseaseGroup, occurrences, extent, covariateFiles, covariateDirectory);
    ...
    private DiseaseGroup createDiseaseGroup(int id, String name, String abbreviation, boolean isGlobal) {
    ...
    private void buildPackageShouldCreateAZipContainingModelCode(Path directory) throws Exception {
        ...
        assertThat(description).contains("Version: 0.1-5");
    }

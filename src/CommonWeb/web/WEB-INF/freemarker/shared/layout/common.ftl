...
<html class="no-js">
    <head>
        ...
        <link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/jasny-bootstrap/3.1.2/css/jasny-bootstrap.css">
    ...
    <body>
        ...
        <!-- Require -->
        <script type="text/javascript" data-main="<@spring.url '${mainjs}' />" src="//cdnjs.cloudflare.com/ajax/libs/require.js/2.1.11/require.js"></script>
    </body>
</html>
</#macro>

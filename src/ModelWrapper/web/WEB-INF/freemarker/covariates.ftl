    ...
    <@p.panel "add-covariate-body" "Add Covariate File" true>
        ...
        <@f.form "add-covariate-form" "Upload" "Uploading ...">
            ...
            <div class="hidden" data-bind="css: { hidden: false }">
                ...
                <div class="alert alert-warning" data-bind="visible: !uploadPath.isValid() && uploadPath()"><p data-bind="text: 'A file already exists at the target path (./' + uploadPath() + '), either change the subdirectory or rename the file and try again.'"></p></div>
                <div class="alert alert-info" data-bind="visible: uploadPath.isValid() && uploadPath()"><p data-bind="text: 'File will be uploaded to ./' + uploadPath()"></p></div>
            </div>
        </@f.form>
    </@p.panel>

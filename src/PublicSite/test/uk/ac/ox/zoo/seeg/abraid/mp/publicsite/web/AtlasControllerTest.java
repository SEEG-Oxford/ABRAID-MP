...
public class AtlasControllerTest {
    ...
    private void stubLayerRelatedServices(ModelRunService modelRunService, DiseaseService diseaseService) {
        ...
        when(modelRun1.getRequestDate()).thenReturn(new DateTime(1413196073L * 1000));
        when(modelRun2.getRequestDate()).thenReturn(new DateTime(813195997L * 1000));
        when(modelRun3.getRequestDate()).thenReturn(new DateTime(2113195997L * 1000));

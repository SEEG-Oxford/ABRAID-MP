            ...
            <div class="col-sm-6">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-4">
                            <input class="form-control" id="min-high-frequency-countries" data-bind="value: minHighFrequencyCountries, valueUpdate: 'input', disable: !occursInAfrica()">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-4">
                            <input class="form-control" id="high-frequency-threshold" data-bind="value: highFrequencyThreshold, valueUpdate: 'input', disable: !occursInAfrica()">
                        </div>
                    </div>
                </div>
            </div>

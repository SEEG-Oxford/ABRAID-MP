                ...
                <div class="panel-body" id="user-body">
                    ...
                    <p class="form-group">
                        ...
                        <span id="user-show" class="input-group btn-group" data-bind="foreach: [ { value: true, label: 'Show me' }, { value: false, label: 'Don\'t show me' } ]">
                            <label class="btn btn-default" data-bind="css: { active: $parent.publiclyVisible() === value, disabled: find('isSubmitting') }">
                                <input type="radio" name="user-show" data-bind="formRadio: { selected: $parent.publiclyVisible, value: value }">
